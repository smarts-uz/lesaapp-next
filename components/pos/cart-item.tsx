            ...
            <QuantityControl
              ...
              onQuantityChange={(newQuantity) => {
                if (item.type === "bundle" && item.bundleItems) {
                  ...
                  const updatedBundleItems = item.bundleItems.map(
                    (bundleItem) => {
                      // Calculate the new quantity for this item
                      const newItemQuantity = Math.round(
                        bundleItem.quantity * ratio,
                      );
          ...
          {item.type === "bundle" && (
            <>
              ...
              <Button
                ...
                title={
                  isExpanded ? "Collapse bundle items" : "Expand bundle items"
                }
              >
                {isExpanded ? (
                  ...
                  .map((bundleItem) => (
                    ...
                    >
                      ...
                      {bundleItem.selectedOptions &&
                        Object.entries(bundleItem.selectedOptions).length >
                          0 && (
                          <div className="text-xs text-muted-foreground mt-1">
                            {Object.entries(bundleItem.selectedOptions).map(
                              ([key, value]) => (
                                <div key={key}>
                                  {key}:{" "}
        ...
        <div className="border rounded-lg p-4 mt-2 bg-muted/20">
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <Button variant="ghost" size="sm" onClick={onCloseBundleEditor}>
                Done
              </Button>
            </div>
